...
insert into parents (parent_name, work_place, tel_number, student_id)
    values
        ('Иванов Иван Петрович','Фирма 1','0631234567',1),
        ('Петров Петр Сидорович','Фирма 2','0951234567',2),
        ('Сидоров Сидор Семенович','Фирма 2','0971234567',3),
        ('Семенов Семен Иванович','Фирма 3','0991234567',4);

# перечень инцидентов со студентами
select
